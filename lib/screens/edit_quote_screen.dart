...
class _EditQuoteScreenState extends ConsumerState<EditQuoteScreen> {
  ...
  void initState() {
    ...
    _pageController.text = widget.quote.page.toString();
    _memoController.text = widget.quote.comment ?? '';
    _isImportant = widget.quote.isImportant;
  }
  ...
  Future<void> _saveQuote() async {
    ...
    try {
      ...
      // updateQuote가 업데이트된 Quote 객체를 반환함
      final updatedQuote = await quoteService.updateQuote(
        quoteId: widget.quote.id,
        content: _quoteController.text.trim(),
        page: page,
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('인용구 수정 실패: ${e.toString()}'),
